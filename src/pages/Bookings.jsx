        ...
        <div className="overflow-x-auto w-full">
          <table className="min-w-max w-full text-sm">
            <thead className="bg-gray-50 text-gray-400 text-xs uppercase tracking-wide">
              <tr>
                <th className="px-4 py-3 text-left whitespace-nowrap">Booking ID</th>
                ...
                <th className="px-4 py-3 text-left whitespace-nowrap">Total Fee</th>
                ...
                filtered.map((b) => {
                  ...
                  return (
                    <tr key={b.id} className={`border-t hover:bg-gray-50 transition-colors ${isNew ? "bg-teal-50 border-l-4 border-l-teal-500" : ""}`}>
                      ...
                      <td className="px-4 py-3 font-semibold text-gray-800 whitespace-nowrap">{fmt(b.totalFee)}</td>
                      <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{b.paymentMethod}</td>
